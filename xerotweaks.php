 ...
 */
function xerotweaks_civicrm_xmlMenu(&$files) {
  _xerotweaks_civix_civicrm_xmlMenu($files);
}
 ...
 */
function xerotweaks_civicrm_managed(&$entities) {
  _xerotweaks_civix_civicrm_managed($entities);
}
 ...
 */
function xerotweaks_civicrm_caseTypes(&$caseTypes) {
  _xerotweaks_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function xerotweaks_civicrm_angularModules(&$angularModules) {
  _xerotweaks_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function xerotweaks_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _xerotweaks_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
